...
<style type="text/css">
table.member {width:60%;}
</style>
</head>
<body>
<div align="center">
<h2>회 원 정 보</h2>
<form action="../admin/memberUpdate.html" method="post" onsubmit="return check(this)">
...
<tr><td colspan="2" align="center"><input type="submit" value="정보 수정"/>
